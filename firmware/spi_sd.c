...
int sd_init() {
    ...
    // Set slow SPI clock (div=48 -> 27 MHz / 96 = 281.25 kHz) for initialization
    reg_spimaster_clkdiv = 48;
    ...
    // Set fast SPI clock (div=8 -> 1.34 MHz) for normal reads/writes
    reg_spimaster_clkdiv = 8;
    return 0;
}
